...
static Sound make_hero_tone(float f0, float f1, float duration, float volume) {
    Sound sound = {0};
    if (!IsAudioDeviceReady() || duration <= 0.0f) return sound;
    ...
    for (int i = 0; i < frame_count; i++) {
        ...
        float env = sinf(t * PI);
        if (duration > 0.18f) env *= (1.0f - t * 0.25f);
...
static void play_ui_sound(Sound s) {
    if (IsAudioDeviceReady() && s.frameCount > 0) PlaySound(s);
}
...
void ui_state_init(UIState *ui, GameState *gs) {
    ...
    /* Keep the box-only renderer everywhere else, but allow age-specific
       town center art. */
    ui->tex_town_centers[0]              = load_game_texture("assets/buildings/tamil_town_center.png");
    ui->tex_town_centers[1]              = load_game_texture("assets/buildings/tamil_town_center.png");
    ui->tex_town_centers[2]              = load_game_texture("assets/buildings/tamil_town_center.png");
    ui->tex_town_centers[3]              = load_game_texture("assets/buildings/tamil_town_center.png");
    ...
    ui->tex_lumber_camps[0]              = load_game_texture("assets/buildings/tamil_lumber_camp.png");
    ui->tex_lumber_camps[1]              = load_game_texture("assets/buildings/tamil_lumber_camp.png");
    ui->tex_lumber_camps[2]              = load_game_texture("assets/buildings/tamil_lumber_camp.png");
    ui->tex_lumber_camps[3]              = load_game_texture("assets/buildings/tamil_lumber_camp.png");
    ui->tex_barracks[0]                  = load_game_texture("assets/buildings/tamil_barracks.png");
    ui->tex_barracks[1]                  = load_game_texture("assets/buildings/tamil_barracks.png");
    ui->tex_barracks[2]                  = load_game_texture("assets/buildings/tamil_barracks.png");
    ui->tex_barracks[3]                  = load_game_texture("assets/buildings/tamil_barracks.png");
    ui->tex_archery_ranges[0]            = load_game_texture("assets/buildings/tamil_archery_range.png");
    ui->tex_archery_ranges[1]            = load_game_texture("assets/buildings/tamil_archery_range.png");
    ui->tex_archery_ranges[2]            = load_game_texture("assets/buildings/tamil_archery_range.png");
    ui->tex_archery_ranges[3]            = load_game_texture("assets/buildings/tamil_archery_range.png");
    ...
    ui->tex_blacksmiths[0]               = load_game_texture("assets/buildings/tamil_blacksmith.png");
    ui->tex_blacksmiths[1]               = load_game_texture("assets/buildings/tamil_blacksmith.png");
    ui->tex_blacksmiths[2]               = load_game_texture("assets/buildings/tamil_blacksmith.png");
    ui->tex_blacksmiths[3]               = load_game_texture("assets/buildings/tamil_blacksmith.png");
    ...
    ui->tex_mining_camps[0]              = load_game_texture("assets/buildings/tamil_mining_camp.png");
    ui->tex_mining_camps[1]              = load_game_texture("assets/buildings/tamil_mining_camp.png");
    ui->tex_mining_camps[2]              = load_game_texture("assets/buildings/tamil_mining_camp.png");
    ui->tex_mining_camps[3]              = load_game_texture("assets/buildings/tamil_mining_camp.png");
    ui->tex_watch_towers[0]              = load_game_texture("assets/buildings/tamil_watch_tower.png");
    ui->tex_watch_towers[1]              = load_game_texture("assets/buildings/tamil_watch_tower.png");
    ui->tex_watch_towers[2]              = load_game_texture("assets/buildings/tamil_watch_tower.png");
    ui->tex_watch_towers[3]              = load_game_texture("assets/buildings/tamil_watch_tower.png");
    ui->tex_monasteries[0]               = load_game_texture("assets/buildings/tamil_monastery.png");
...
void ui_state_deinit(UIState *ui) {
    ...
    if (ui->snd_hero_enter.frameCount > 0) UnloadSound(ui->snd_hero_enter);
    if (ui->snd_hero_attack.frameCount > 0) UnloadSound(ui->snd_hero_attack);
    if (ui->snd_hero_exit.frameCount > 0) UnloadSound(ui->snd_hero_exit);
    if (ui->snd_hero_block.frameCount > 0) UnloadSound(ui->snd_hero_block);
}
...
void ui_sync_hero_possession(UIState *ui, GameState *gs) {
    ...
    if (phase == HERO_POSSESSION_OFF || gs->hero.unit_id < 0 ||
        gs->hero.unit_id >= MAX_UNITS) return;
    ...
    if (gs->hero.transition_time > 0.0f &&
        ...
        t = clampf(gs->hero.transition_timer / gs->hero.transition_time, 0.0f, 1.0f);
        if (phase == HERO_POSSESSION_EXITING) t = 1.0f - t;
    }

    float saved_zoom = ui->hero_has_saved_camera ? ui->hero_saved_camera.zoom : ui->camera.zoom;
    ui->camera.target.x = lerpf(ui->camera.target.x, target.x, 0.25f + 0.55f * t);
    ui->camera.target.y = lerpf(ui->camera.target.y, target.y - 34.0f, 0.25f + 0.55f * t);
